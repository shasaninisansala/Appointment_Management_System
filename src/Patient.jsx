...
function Patient() {
  ...
  // Trim contact number for validation
  const newContact = editForm.contactNumber?.trim();

  // Check if another patient already has this contact number
  const duplicate = patients.find(
    (p) => p.contactNumber === newContact && p.id !== editingId
  );
  ...
  try {
    await axios.put(`${API_URL}/${editingId}`, {
      ...editForm,
      contactNumber: newContact, // ensure trimmed
    });
